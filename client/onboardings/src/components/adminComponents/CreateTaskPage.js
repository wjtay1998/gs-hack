...
function DashboardContent() {
  ...
  const [editor, onEditorChange] = React.useState('<p>Your initial <b>html value</b> or any fancy details</p>');
  ...
  const onIsRequiredChange = (e) => {setIsRequired(e.target.checked); console.log(e.target.checked)};
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        >
          <Container component="main" maxWidth="lg" sx={{ mb: 4 }}>
            <Paper justifyContent="center" variant="outlined" sx={{ my: { xs: 1, md: 6 }, p: { xs: 2, md: 3 }, borderRadius: '15px',
            ...
            <React.Fragment>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  <FormControlLabel control={<Checkbox onChange={onIsRequiredChange} defaultChecked />} label="Required" />
                </Grid>
